...
public class ComboBoxesCreator {
	...
	private static DefaultComboBoxModel<ImageText> populateTypes(String className,String fileType, int imageCount,Dimension d) {
		
//		this method creates an image combo box that has the images who's names are represented by the strings
...
//		located in the "src\gui\images\VehicleTypes\<className>" folder
	...
	public static JComboBox<ImageText> createTypesComboBox(String className, String fileType, int imageCount, Dimension d) {
